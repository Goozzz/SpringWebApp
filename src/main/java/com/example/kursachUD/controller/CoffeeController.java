...
public class CoffeeController {
    ...
    public String coffee(Map<String, Object> model) {
        Iterable<Coffee> coffees = coffeeRepo.findAll();
        model.put("coffees", coffees);
        return "coffee";
    }

    @PostMapping("addCoffee")
    public String addCoffee(@RequestParam String coffeeName,
                            @RequestParam Integer coffeePrice,
    ...
    public String updateCoffee(@RequestParam Integer coffeeId,
